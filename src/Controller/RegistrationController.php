...
class RegistrationController extends AbstractController
{
  ...
  */
   ...
   */
    ...
    public function registerstagiaire(Users $user = null,Request $request, UserPasswordHasherInterface $userPasswordHasher, UserAuthenticatorInterface $userAuthenticator, UsersAuthenticator $authenticator, EntityManagerInterface $entityManager, ManagerRegistry $use): Response
    {
        $users = $use->getRepository(Users::class)->findAll();
        $sections = $use->getRepository(Sections::class)->findAll();
        $filieres = $use->getRepository(Filieres::class)->findAll();
        ...
        */
        ...
        public function deletestagiaire(int $id, Users $user, ManagerRegistry $use,  EntityManagerInterface $manager): Response
        {
            $user = $use->getRepository(Users::class)->find($id);
            $this->addFlash('success', 'Votre messsage est supprimé !');
            $manager->remove($user);
